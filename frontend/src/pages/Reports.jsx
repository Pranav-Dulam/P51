...
export default function Reports() {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://137.184.40.86:3000/api/charts/reports/adoption", {
        headers: {
    ...
    axios
      .get("http://137.184.40.86:3000/api/charts/reports/efficiency", {
        headers: {
          Authorization: `Bearer ${token}`,
          "Content-Type": "application/json"
        }
    ...
    axios
      .get("http://137.184.40.86:3000/api/charts/reports/cost", {
        headers: {
          Authorization: `Bearer ${token}`,
          "Content-Type": "application/json"
        }
